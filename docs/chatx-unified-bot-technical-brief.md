...
flowchart LR
  ...
  GW["统一机器人网关<br/>Java + Spring Boot"]
...
| Java + Spring Boot 网关计划 | 已完成 | 已拆分 GW-00～GW-10，可交给内网代码 Agent 分阶段开发                                        |
...
2. 提供官方机器人 Token 管理方式及企业 `principalId ↔ OpenID` 映射来源；
3. 冻结平台入站验签、重试、顺序，以及下行幂等和结果查询能力；
...
- [Java + Spring Boot 网关开发计划](./chatx-unified-bot-gateway-java-development-plan.md)
