    ...
    <>
      ...
      {expanded && (
        <tr className="border-b border-border/50 bg-muted/20">
          <td colSpan={showSuspectedTechnicalDetailMetric ? 15 : 14} className="px-3 py-3">
...
function ProjectListSection({
  ...
  const tableColumnCount = showSuspectedTechnicalDetailMetric ? 15 : 14
      ...
      >
        <table
          className={cn(
            ...
            showSuspectedTechnicalDetailMetric ? "min-w-[2220px]" : "min-w-[2080px]"
          )}
        >
          {/*
