...
const BASE_MOCK_MARKET_DATA: Record<MarketItemType, MarketItem[]> = {
  ...
  skill: [
    ...
    },
    {
      ...
      user_id: "80***31",
      guidance:
        "入口1：帮我检测并修***区下相应项目问题帮我检测并修***区下相应项目问题帮我检测并修***区下相应项目问题帮我检测并修***区下相应项目问题帮我检测并修***区下相应项目问题帮我检测并修***区下相应项目问题",
      ip: "99.***.***.118",
      description: "数***",
      filename: "jav***or.zip",
    ...
    },
    {
      ...
      ip: "99.***.***.166",
      description:
        "- agent-br***rror.comagent-br***rror.comagent-br***rror.comagent-br***rror.comagent-br***rror.comagent-br***rror.comagent-br***rror.comagent-br***rror.comagent-br***rror.comagent-br***rror.comagent-br***rror.com",
      filename: "age***.0.zip",
