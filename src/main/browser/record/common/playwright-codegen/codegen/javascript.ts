...
${useText ? '\ntest.use(' + useText + ');\n' : ''}
  ...
  generateTestFooter(_saveStorage: string | undefined): string {
    return `});`;
  }
...
function formatContextOptions(options: BrowserContextOptions, deviceName: string | undefined, _isTest: boolean): string {
