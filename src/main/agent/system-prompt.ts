...
In Auto Mode, requests automatically submit each question's recommended option after five minutes when no timeout is provided. Normal runs wait indefinitely unless the call explicitly provides a timeout.
